...
const footerHTML = `
    <!-- Footer -->
    <footer class="bg-academic-card border-t border-academic-border mt-20 pt-16 pb-8 font-readex relative z-10" style="padding-bottom: 6rem;">
...
// Insert the footer right before <!-- Floating Glass Pill Toolbar --> or just before </div></div> at the end of main layout
const targetInsert = `<!-- Floating Glass Pill Toolbar -->`;
html = html.replace(targetInsert, footerHTML + '\n    ' + targetInsert);

// Now modify the Citation text to include Zenodo library statement.
...
fs.writeFileSync('posts/story_of_david_1.html', html);
console.log('Footer and citation added to story_of_david_1.html');
